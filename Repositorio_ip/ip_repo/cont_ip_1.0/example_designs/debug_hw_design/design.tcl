...
proc create_ipi_design { offsetfile design_name } {
	...
	set cont_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:cont_ip:1.0 cont_ip_0 ]
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins cont_ip_0/C00_AXI]
	connect_bd_net [get_bd_pins cont_ip_0/c00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins cont_ip_0/c00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_cont_ip_0_C00_AXI_* ]]
	puts $fp "set c00_axi_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:cont_ip:1.0]]]]
